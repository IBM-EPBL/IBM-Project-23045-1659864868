...
# API = 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

def alert_mail(cname,items,quantity):
    print(cname,items,quantity)
    sg = sendgrid.SendGridAPIClient(api_key='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')
    ...
    msg+="<br/><br/><table style='border: 1px solid black; border-collapse: collapse;'><tr><th>Item name</th><th>Quantity</th></tr>"
